...
def step_simulation_rk4(ndominoes, theta, omega):
  C0 = omega
  K0 = solve_alpha(ndominoes, theta, omega)
  C1 = omega + 0.5*dt*K0
  K1 = solve_alpha(ndominoes, theta + 0.5*dt*C0, C1)
  C2 = omega + 0.5*dt*K1
  K2 = solve_alpha(ndominoes, theta + 0.5*dt*C1, C2)
  C3 = omega + dt*K2
  K3 = solve_alpha(ndominoes, theta + dt*C2, C3)
